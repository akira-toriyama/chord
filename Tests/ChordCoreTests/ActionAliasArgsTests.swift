...
@Suite struct ActionAliasArgsTests {
    ...
    @Test func bareCallOnTemplatedAliasIsRejected() throws {
        ...
        #expect(
            res.warnings.contains {
                $0.kind == .actionAliasCallError && $0.message.contains("{{1}}")
            })
    }
    ...
    @Test func tooFewArgsIsRejected() throws {
        ...
        #expect(
            res.warnings.contains {
                $0.kind == .actionAliasCallError && $0.message.contains("{{3}}")
            })
    }
    ...
    @Test func undefinedAliasInCallFormIsRejected() throws {
        ...
        #expect(
            res.warnings.contains {
                $0.kind == .undefinedActionAlias && $0.message.contains("@missing")
            })
    }
