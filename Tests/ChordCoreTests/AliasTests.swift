...
@Suite struct AliasTests {
    ...
    @Test func aliasExpansionInActionShell() throws {
        ...
        #expect(res.config.actionAliases["rift_focus_next"] == "rift-cli execute window next")
